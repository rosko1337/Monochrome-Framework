...
#define MC_CAPSLOCK VK_CAPITAL
#define MC_TAB VK_TAB
...
#define MC_SQUARE_BRACKET_RIGHT VkKeyScan('[')
#define MC_SQUARE_BRACKET_LEFT VkKeyScan(']')
#define MC_BACKSLASH VkKeyScan('\\')
#define MC_SLASH VkKeyScan('/')
...
{
public:
	// Gets the key code of a character used to detect keypress
